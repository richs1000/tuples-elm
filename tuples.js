						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {debug: a, userInput: b, history: c, question: d, success: e, feedback: f, randomValues: g, mastery: h, numerator: i, denominator: j, implementMastery: k};
										};
									};
								};
							};
...
var _user$project$PairsAndTuples$subscriptions = function (model) {
	return _user$project$Ports$ssData(_user$project$MessageTypes$GetValuesFromSS);
};
var _user$project$PairsAndTuples$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$PairsAndTuples$subscriptions})
};

var Elm = {};
Elm['PairsAndTuples'] = Elm['PairsAndTuples'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['PairsAndTuples'], 'PairsAndTuples', typeof _user$project$PairsAndTuples$main === 'undefined' ? null : _user$project$PairsAndTuples$main);
